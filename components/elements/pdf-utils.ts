 ...
 * @param format - Image format (default: "image/webp")
 * @param quality - Image quality 0-1 (default: 0.8, only for lossy formats like webp/jpeg)
...
export async function screenshotPage(
  ...
  pageNumber: number,
  scale = 2,
  format: "image/png" | "image/jpeg" | "image/webp" = "image/webp",
  quality = 0.8,
): Promise<string> {
  ...
  // Use quality parameter for lossy formats (webp, jpeg)
  if (format === "image/png") {
